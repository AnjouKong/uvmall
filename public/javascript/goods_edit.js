...
{
    console.log(picJson);
	var picHtml = template.render('picTemplate',{'picRoot':picJson.img,'picAddHost': imagesHostUrl + picJson.img});
...
$('#fileUpload').fileupload({
    ...
    done: function (e, data)
    {
    	...
    	{
    	    var imagData = {
    	        img:data.result.data.relativeUrl,
                md5:data.result.data.md5,
            };

    		uploadPicCallback(imagData);
    	}
    	else
    	{
            ...
            $('#uploadPercent').text(data.result.message);
    	}
    },
